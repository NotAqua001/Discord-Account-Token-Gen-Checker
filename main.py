...
os.system("Discord Account Token Gen Made by Gamecooler19#3016")

def Spinner():
	l = ['|', '/', '-', '\\']
	for i in l+l+l:
		sys.stdout.write('\r' + Fore.YELLOW +'Starting DiscordAccGen...'+i)
		sys.stdout.flush()
		time.sleep(0.2)
...
print(Fore.WHITE +Fore.RED +"                                         Welcome to "+Fore.WHITE+" DiscordAccGen "+Fore.WHITE+"- 2022 -")
	...
	with open('Generated.txt', 'r') as f:
	    for line in f:
	        ...
	        try:
	            ...
	            print(f"{Fore.CYAN}Error, please contact with Gamecooler19#3016 {Fore.RESET}")
pass
if opcion=='3':
	os.system("cls")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"--------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	print(Fore.WHITE +Fore.RED +"                                         DiscordAccGen"+Fore.WHITE+" Made by "+Fore.RED+"Gamecooler19")
	print(Fore.WHITE +Fore.RED +"                                         [Discord] "+Fore.RED+"Gamecooler19#3016")
	print(Fore.WHITE +Fore.RED +"                                         [Server] "+Fore.RED+"https://discord.gg/Rsg2AsjqKx")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	input(Fore.RED +Fore.RED +"\nEnter to exit")
	os.system("cls")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
